...
for infile, outfile in zip(args.infile, args.outfile):
    ...
    print("\tAllow tint     : "+('\u001b[32m' if allow_tint else '\u001b[31m') +f'{allow_tint}\u001b[37m' \
        +"\tAllow mask     : "+('\u001b[32m' if allow_mask else '\u001b[31m')+f'{allow_mask}\u001b[37m')
    print("\tAllow flip X   : "+('\u001b[32m' if allow_flip_x else '\u001b[31m')+f'{allow_flip_x}\u001b[37m' \
        +"\tAllow flip Y   : "+('\u001b[32m' if allow_flip_y else '\u001b[31m')+f'{allow_flip_y}\u001b[37m')
    print('')
    ...
    if (allow_flip_y == True):
        ...
        f_out.write('\tCMP R2,#'+f'{CLIP_BOTTOM + sprite_height - 1}\n')
        f_out.write('\tBGE draw_'+label_name+'_sprite_exit\n')
        ...
        f_out.write('\ndraw_'+label_name+'_sprite_skip_flip_y:\n')
        ...
        while ix < image_width:
            ...
            for i in range(0,sprite_height):
                ...
                if (allow_flip_x == True):
                    ...
                    f_out.write('\n'+label_name+f'_sprite_{tile}_scanline_{i}_flip_x:\n')
